...
export default function Home() {
  ...
  const faqItems = [
    {
      ...
      answer:
        "Our pickup and delivery service is simple and convenient. Schedule a pickup through our app, website, or by calling us. We'll collect your laundry at the scheduled time, process it according to your preferences, and deliver it back to you fresh and clean at the time you specify.",
      icon: "🚚",
      color: "blue",
    },
    {
      ...
      answer:
        "Our standard turnaround time is 24-48 hours, depending on the service. We also offer express services with same-day or next-day delivery for an additional fee. When scheduling your pickup, you can select your preferred delivery time.",
      icon: "⏱️",
      color: "green",
    },
    {
      ...
      answer:
        "Yes, we're committed to environmental sustainability. We use eco-friendly, biodegradable detergents and cleaning solutions that are gentle on your clothes and the planet, while still providing exceptional cleaning results.",
      icon: "🌱",
      color: "emerald",
    },
    {
      ...
      answer:
        "Delicate garments receive special attention and care. We inspect each item, sort them appropriately, and use gentle cleaning methods according to the care label instructions. For particularly delicate items, we recommend our specialized dry cleaning service.",
      icon: "👔",
      color: "purple",
    },
    {
      ...
      answer:
        "We accept all major credit and debit cards, UPI payments, cash on delivery, and online bank transfers. You can also set up automatic payments through our app for regular customers.",
      icon: "💳",
      color: "amber",
    },
    {
      ...
      answer:
        "Customer satisfaction is our priority. If you have any concerns, please contact us within 48 hours of delivery. You can call our customer service line, use the 'Report an Issue' feature in our app, or send us an email, and our team will promptly address your concern.",
      icon: "🛎️",
      color: "rose",
    },
  ];
  ...
  const serviceOffers = {
    "All Services": {
      ...
      description:
        'Enjoy <span class="font-bold text-blue-600">25% off</span> on your first order! Our premium cleaning services ensure your clothes look fresh and pristine every time.',
      code: "WASHCLOTHES25",
    ...
    "Wash & Fold": {
      ...
      description:
        'Get <span class="font-bold text-blue-600">30% off</span> on Wash & Fold services for orders over 5kg! We\'ll take care of sorting, washing, and perfectly folding your items.',
      code: "WASHFOLD30",
    ...
    "Dry Cleaning": {
      ...
      description:
        'Receive <span class="font-bold text-purple-600">20% off</span> on all dry cleaning services! Ideal for suits, dresses, and delicate fabrics that require special care.',
      code: "DRYCLEAN20",
    ...
    Ironing: {
      ...
      description:
        'Save <span class="font-bold text-green-600">15% off</span> on our premium ironing services! Get that perfect pressed look for your office wear and formal attire.',
      code: "IRONPRO15",
    ...
    "Shoe Cleaning": {
      ...
      description:
        'Book our <span class="font-bold text-orange-600">shoe cleaning service</span> and get a free shoe protection spray worth ₹250! Restore the look of your favorite shoes.',
      code: "SHOECLEAN",
  ...
  return (
    <main className="min-h-screen bg-white">
            ...
            {navItems.map((item, i) => (
              ...
              >
                <motion.button
                  ...
                  className={`text-sm font-medium capitalize py-2 px-1 ${
              ...
              <div className="w-full relative z-10 space-y-2">
                {navItems.map((item, i) => (
                  ...
                  >
                    <button
                      onClick={() => scrollToSection(item)}
                      className={`py-3 px-4 text-lg font-medium capitalize w-full text-left flex items-center space-x-2 rounded-md ${
                        activeSection === item
      ...
      <section
        id="home"
        className="min-h-screen pt-28 pb-20 md:pt-36 md:pb-28 overflow-hidden relative"
      >
          ...
          <div className="flex flex-col md:flex-row items-center max-w-7xl mx-auto">
            ...
            >
              ...
              >
                ...
                , we make laundry effortless. Fresh, clean, and perfectly
                folded—because your time is precious.
              </motion.p>
              ...
              >
                {[
                  ...
                  >
                    <div
                      className={`w-10 h-10 rounded-full bg-${feature.color}-100 flex items-center justify-center text-lg shadow-sm group-hover:bg-${feature.color}-200 transition-colors duration-300`}
                    >
                      {feature.icon}
                    </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              At WashMyClothes, we believe that laundry should be effortless.
              Our professional cleaning services ensure that your garments are
              fresh, spotless, and perfectly folded—every time. With our
              state-of-the-art equipment and eco-friendly detergents, we take
              care of your laundry so you can focus on what truly matters.
            </motion.p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Enjoy same-day or next-day service options. We ensure quick, efficient, and hassle-free laundry care.",
                icon: "⏳",
                color: "yellow-50",
              },
              {
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              We offer a comprehensive range of laundry services to meet all
              your needs.
            </motion.p>
          </motion.div>
              ...
              >
                ...
                <div className="relative overflow-hidden h-56">
                  ...
                  >
                    ...
                    {/* Gradient Overlay */}
                    <div
                      className={`absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-60 group-hover:opacity-70 transition-opacity duration-300`}
                    ></div>
                  </motion.div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              Find answers to commonly asked questions about our premium laundry
              services. Still have questions? Feel free to contact us anytime.
            </motion.p>
          </motion.div>
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div
                        className={`w-10 h-10 rounded-full bg-${faq.color}-100 flex items-center justify-center flex-shrink-0`}
                      >
                    ...
                    <motion.div
                      animate={{
                        ...
                        color:
                          openFAQ === index
                            ? `var(--color-${faq.color}-500)`
                            : "var(--color-gray-400)",
                      }}
                      transition={{ duration: 0.3 }}
                      className={`text-${
                        openFAQ === index ? `${faq.color}-500` : "gray-400"
                      }`}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <AnimatePresence>
                    {openFAQ === index && (
                      ...
                      >
                        <div
                          className={`px-6 pb-6 pt-0 text-gray-600 border-t border-gray-100 bg-gradient-to-br from-white to-${faq.color}-50`}
                        >
            ...
            >
              ...
              <div className="relative z-10">
                ...
                >
                  ...
                  questions or concerns you might have about our services.
                </motion.p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              Conveniently located in the heart of the city. Drop by or schedule
              a pickup!
            </motion.p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center max-w-6xl mx-auto">
            ...
            >
              <motion.div
                ...
                whileHover={{
                  boxShadow:
                    "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -6px rgba(0, 0, 0, 0.1)",
                  y: -5,
                }}
                transition={{ duration: 0.3 }}
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Washmyclothes, opposite BR Hi-Tech Theatre,
                      <br />
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              ...
              <svg
                className="w-5 h-5 ml-2 animate-pulse-slow"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path
      ...
      <section
        id="contact"
        className="py-24 relative overflow-hidden bg-gradient-to-b from-gray-900 to-gray-800 text-white"
      >
        {/* Enhanced background elements */}
        <div className="absolute inset-0 z-0">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-8">
                    ...
                    >
                      ...
                      <div>
                        <h4 className="font-medium text-blue-300 mb-1 text-lg">
                          Phone
                        </h4>
                        <motion.a
                          whileHover={{ x: 5 }}
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <h4 className="font-medium text-blue-300 mb-5 text-lg">
                      Connect With Us
                    </h4>
                      ...
                      {[
                        {
                          ...
                          url: "https://www.facebook.com/Washmyclothes.co.in/",
                          color: "from-blue-500 to-blue-600",
                        },
                        {
                          icon: <Instagram size={20} />,
                          url: "https://www.instagram.com/wash_my_clothes?utm_source=qr&igsh=MWt3NXJ2OTE1a2x6bA==",
                        ...
                        {
                          icon: <Mail size={20} />,
                          url: "mailto:washmyclotheshyd@gmail.com",
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="w-full max-w-md mx-auto bg-gray-700 rounded-full px-4 py-1 flex items-center">
                    ...
                    <span className="text-sm text-gray-300">
                      https://maps.google.com/?q=WashMyClothes
                    </span>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
            ...
            >
              ...
              >
                We are committed to providing the best laundry service in town.
                Our team is dedicated to ensuring your clothes are cleaned and
                cared for with the utmost attention.
              </motion.p>
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <motion.li
                      ...
                      viewport={{ once: true }}
                      className={`flex justify-between text-gray-400 py-1 border-b border-gray-700 last:border-0 ${
                        schedule.highlight ? "text-blue-300" : ""
                      }`}
                    >
