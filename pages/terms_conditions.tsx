...
const TermsAndConditions: NextPage = () => {
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <p className="mb-4">Last updated: August 03, 2025</p>
      <p className="mb-8">
      ...
      <ul className="list-disc pl-6 mb-8 space-y-3">
        ...
        <li>
          <p>
            ...
            this Agreement) refers to WASH MY CLOTHES.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to WASH MY CLOTHES, accessible from{" "}
            <a
      ...
      <p className="mb-8">
        ...
        Application may also be subject to other local, state, or national laws
        of India.
      </p>
      ...
      <ul className="list-disc pl-6 space-y-3">
        ...
        <li>
          <p>By phone number: 8712326333</p>
        </li>
      </ul>
    </div>
  );
